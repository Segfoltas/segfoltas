...
$sendingAccountUsername     = 'povilas@segfoltas.com';
$sendingAccountPassword     = 'sweeojzfdrishoon';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'info@segfoltas.com'; // REQUIRED value.
$recipientName              = 'Povilas Sid';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Segfoltas.com'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Segfoltas';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Europe/Vilnius';         // OPTIONAL, but some servers require this to be set. 
